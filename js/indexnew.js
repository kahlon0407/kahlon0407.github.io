...
function right1(data) {
    var myChart = echarts.init(document.getElementById('right1'), 'diy');
    var option = {
        title: {
            text: "全国确诊省市TOP10",
            textStyle: {
...
function left1(data) {
    var myChart = echarts.init(document.getElementById('left1'), 'diy');
    var option = {
        title: {
            text: "全国累计趋势",
            textStyle: {
...
function left2(data) {
    var myChart = echarts.init(document.getElementById('left2'), 'diy');
    var option = {
        title: {
            text: "全国新增趋势",
            textStyle: {
